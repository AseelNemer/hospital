...
//                     <button className='btns' variant="contained" onClick={loginnow}>Log in</button>
//                     <h1>if you'r new register here!</h1>
//                     <button className='btns' component={Link} to="/register" variant="contained" color="primary"> 
